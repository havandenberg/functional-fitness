  ...
  <>
    <l.PageContent mx="auto">
      ...
      <l.Div p={th.spacing.md}>
        ...
        <ty.Text mb={th.spacing.md}>
          Each session is <l.Primary>~30 mins</l.Primary> in length and consists of exercises of all differnet types,
          with the goal to make improvements in all areas of your personal fitness over time.
        </ty.Text>
        <ty.Text mb={th.spacing.md}>
